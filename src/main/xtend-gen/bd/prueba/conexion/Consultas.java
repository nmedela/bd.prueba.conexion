...
public class Consultas {
  ...
  public void select() {
    try {
      ...
      final Consumer<Persona> _function = new Consumer<Persona>() {
        public void accept(final Persona user) {
  ...
  public static Cliente buscarClienteParaCrearSeguroDeVida(final int dni) {
    try {
      ...
      boolean _equals = Objects.equal(idPersona, null);
      if (_equals) {
      ...
      boolean _notEquals = (!Objects.equal(idSeguro, null));
      if (_notEquals) {
        SeguroVida _seguroVida = new SeguroVida();
        final Procedure1<SeguroVida> _function = new Procedure1<SeguroVida>() {
          public void apply(final SeguroVida it) {
            try {
